            ...
            >
                ...
                <div className="relative bg-gradient-to-br from-card via-card to-card/95 border-2 border-border/50 rounded-2xl overflow-hidden shadow-2xl">
                    ...
                    <div className="relative bg-black aspect-video">
                        ...
                        <div className="absolute bottom-4 right-4 flex items-center gap-2 px-3 py-2 rounded-lg bg-black/60 backdrop-blur-md border border-white/10">
                            <Maximize2 className="w-4 h-4 text-white/70" />
                            <span className="text-xs text-white/70 font-medium">Presiona ESC para salir</span>
                        </div>
                    </div>
                    ...
                    <div className="p-6 bg-gradient-to-r from-transparent to-card-hover/50 border-t border-border/30">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm text-foreground/70 font-medium">Reproduciendo en loop</span>
                            </div>
                            <div className="flex items-center gap-2">
                      ...
                      {/* ANÁLISIS DE COMBATE */}
                        ...
                        <div className="card p-10 border-t-4 border-t-energy shadow-2xl bg-gradient-to-br from-card to-card/80">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <h2 className="text-2xl font-bold uppercase tracking-wider">Simulación de Avance</h2>
